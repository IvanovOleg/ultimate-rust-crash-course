...
fn main() {
    ...
    let (tx, rx) = channel::unbounded(); // unbounded means that channel can accept as many messages as you want
    ...
    pause_ms(0); // Make sure Thread A has time to get going before we spawn Thread B 100
